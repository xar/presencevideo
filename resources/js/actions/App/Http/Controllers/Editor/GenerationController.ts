...
export const searchCatalog = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: searchCatalog.url(options),
    method: 'get',
})

searchCatalog.definition = {
    methods: ["get","head"],
...
searchCatalog.url = (options?: RouteQueryOptions) => {
    return searchCatalog.definition.url + queryParams(options)
}
...
const searchCatalogForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: searchCatalog.url(options),
    method: 'get',
})
...
searchCatalog.form = searchCatalogForm
...
export const getCatalogModel = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getCatalogModel.url(options),
    method: 'get',
})

getCatalogModel.definition = {
    methods: ["get","head"],
...
getCatalogModel.url = (options?: RouteQueryOptions) => {
    return getCatalogModel.definition.url + queryParams(options)
}
...
const getCatalogModelForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: getCatalogModel.url(options),
    method: 'get',
})
...
getCatalogModel.form = getCatalogModelForm
...
const GenerationController = { models, searchCatalog, getCatalogModel, store, show }
