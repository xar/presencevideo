...
class UpdateProjectRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'video_tracks.*.clips.*.type' => ['sometimes', 'string', 'in:video,text'],
            'video_tracks.*.clips.*.asset_id' => ['required_unless:video_tracks.*.clips.*.type,text', 'integer'],
            ...
            'video_tracks.*.clips.*.text' => ['required_if:video_tracks.*.clips.*.type,text', 'string', 'max:500'],
