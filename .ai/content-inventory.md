...
Source of truth: `config/seo.php`.

## Programmatic SEO Pages
- `/use-cases/ai-video-editor` — AI Video Editor for Fast, Polished Content
...
## Notes
Automated runs should keep this file synchronized when they add or update entries in `config/seo.php`.
